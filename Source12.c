...
float prefboardgametotalmultiple[101];
...
void prefcommonboardlogmultiple1(int h)
{
	...
	prefcommonboardallocatemultiple2(h, 1);
	gameturnmultiple = 1;
}
...
{
	if (prefboardgametotalmultiple[h] >(logprefwholemultipleleft))
	{
		logprefwholemultipleleft = logprefwholemultipleleft + (prefboardgametotalmultiple[h] / 10);
		prefboardgametotalmultiple[h] = prefboardgametotalmultiple[h] * 0.9;
		//logprefwholemultipletaken = logprefwholemultipletaken + prefboardgametotalmultiple[h]/20;
		//prefboardgametotalmultiple[h] = prefboardgametotalmultiple[h] * 1.05;
	}
	else if (prefboardgametotalmultiple[h] > (logprefwholemultipleadded / 80))
	{
		...
		{
			logprefwholemultipletaken = logprefwholemultipletaken + prefboardgametotalmultiple[h] / 2;
			prefboardgametotalmultiple[h] = prefboardgametotalmultiple[h] * 1.5;
		}
	}
