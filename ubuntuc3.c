...
float commonboardgametotalmultipleaddedtakenin[31];
...
void boardrunGames()
{
	...
	for (int h = 1; h<101; h++)
	{
		...
		for (int i = 1; i < 31; i++)
		{
			...
			if (h<2)commonboardgametotalmultipleaddedtakenin[i] = 0;
		}
...
void commonboardlogmultiple(int h)
{
		...
		//turnsasmoneytakeninx = i - 1;
		turnsasmoneytakeninx = commonboardgametotalmultipleaddedtakenin[1]/commonboardgametotalmultipleadded[1];
		gameturnmultiple = ((10000 - basispoint) / 10000) - (turnsasmoneytakeninx*(1 + interest)) + (basispoint / (boardturnsofdiceforagame[h] * 350));
		//turnsasmoneytakeninx = turnsasmoneytakeninx + (commonboardgametotalmultipleaddedtakenin[i]/commonboardgametotalmultipleadded[i]);
		//gameturnmultiple = ((10000 - basispoint) / 10000)*(turnsasmoneytakeninx + 1)
			//- turnsasmoneytakeninx*(1 + interest)
			//+ ((basispoint / (boardturnsofdiceforagame[h] * 350)))*(turnsasmoneytakeninx + 1);
		boardgametotalmultiple[h][1] = boardgametotalmultiple[h][1] * gameturnmultiple;
		commonboardallocatemultiple(h,1);
...
void commonboardallocatemultiple(int h, int i)
{
	...
	else if (boardgametotalmultiple[h][i] > (commonboardgametotalmultipleadded[i] / 50))
	{
		if(boardgametotalmultiple[h][i] < commonboardgametotalmultipleleft[i])
		{
			commonboardgametotalmultipleaddedtakenin[i] = commonboardgametotalmultipleaddedtakenin[i] + boardgametotalmultiple[h][i] / 4;
		}
		else commonboardgametotalmultipleleft[i] = commonboardgametotalmultipleleft[i] - (boardgametotalmultiple[h][i] / 4);
