...
void commonboardprefallocatemultiple(int h, int i)
{
	...
	else if (boardgametotalmultiple[h][i] > (commonboardgametotalmultipleadded[i] / 50))
	{
		if (boardgametotalmultiple[h][i] < commonboardgametotalmultipleleft[i])
		{
			commonboardgametotalmultipletakenin[h] = commonboardgametotalmultipletakenin[h] + boardgametotalmultiple[h][i] / 4;
		}
...
void commonboardpreflogmultiple(int h)
{
	...
	turnsasmoneytakeninx = commonboardgametotalmultipletakenin[h] / boardgametotalmultiple[h][1];
