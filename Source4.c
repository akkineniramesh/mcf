...
int a[101];
long numberofdiceturns = 300000;
void runGame(), TurnsofDice(), fillLadders(), fillSnakes(), numberofGames(), printGameStats(), logmultiple();
int SnakesLadders();
...
void printGameStats()
{
	...
	printf(" gametotalmultiple %f ", gametotalmultiple);
	printf("pos= %d", pos);
	for (int i = 1; i <= 11; i++)
